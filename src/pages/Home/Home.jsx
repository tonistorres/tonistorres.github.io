...
export default class Home extends Component {
  ...
  mensagemLoginUsuarioDigitadoCorretamente() {
    this.setState({
      mensagemInfo:
        "😒 Tive dificuldades ao Pesquisar API. O login foi digitado corretamente? 🕵️",
    });
  }
  ...
  barraInfoDificuldadesAcessoPerfil() {
    const { searchedValue } = this.state;
    this.setState({
      mensagemInfo: `😞 Dificuldades com API perfil não disponível ${searchedValue}.💁 Tente mais tarde!!`,
    });
  }
